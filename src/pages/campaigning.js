      ...
      <Segment vertical style={{ padding: "8em 0em" }}>
        <Container text>
          ...
          <p style={{ fontSize: "1.33em" }}>
            Get involved with Labour on the doorstep and share our message. You
            will find campaigning activities, like street stalls and door
            knocking sessions, here.
          </p>

          <p>Let us know if you'd like to get involved!</p>
          ...
          <Grid columns={2} stackable>
            {upcomingEvents ? (
              upcomingEvents.map(event => <EventItem event={event} />)
            ) : (
