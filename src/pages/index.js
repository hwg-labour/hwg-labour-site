      ...
      <Segment style={{ padding: "4.5em 0em" }} vertical>
        <Container text>
          ...
          <p style={{ fontSize: "1.33em" }}>
            ...
            That means building the homes we need to rent and buy, keeping our
            communities safe, giving our schools the funding they need, and
            restoring the NHS to its place as the envy of the world.
          </p>
