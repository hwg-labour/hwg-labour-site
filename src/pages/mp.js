	...
	<div>
		...
		<Segment style = { { padding: "8em 0em", } } vertical>
			<Container text>
				...
				<p>Please include your full address, postcode and name in any email to Catherine, or she will be unable to take up your case.</p>

				<p><b>Email</b>: <a href="mailto:catherine.west.mp@parliament.uk">catherine.west.mp@parliament.uk</a></p>

				<p><b>Phone</b>: <a href="tel:+442072196141">020 7219 6141</a> </p>

				<p><b>Post</b>: House of Commons, London SW1A 0AA</p>

				<p><b>Twitter</b>: <a href="www.twitter.com/CatherineWest1">@CatherineWest1</a></p>

				<p><b>Facebook</b>: <a href="www.facebook.com/CatherineWestMP">CatherineWestMP</a></p>
			</Container>
		</Segment>
	</div>
);
